...
class Comite extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model ( 'Comite_model', 'usuario' );
	}
	
	/** INICIO - VISTA DE USUARIOS**/
	public function index() {
		$data ['pag'] = "6";
		$this->load->view ( 'comite_view',$data );
	}
	...
	public function lista_usuarios() {
		...
		foreach ( $list as $miembro ) {
			...
			$row [] = $miembro->cargo;
                      ...
                      $row [] = '<div class="text-center"><a href="' . base_url() . 'Archivo/' . $miembro->archivo. '" target="_blank"><i class="fa fa-leanpub fa-2x"></i></a></div>';
...
//                        $row [] = $miembro->archivo;
			...
			$row [] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Editar miembro" onclick="editar_usuario(' . "'" . $miembro->miembro_comiteID . "'" . ')"><i class="fa fa-edit"></i> EDITAR</a>';
