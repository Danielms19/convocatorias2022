							...
							<div class="box-tools pull-right">
									<div class="btn-toolbar">
										<button class="btn btn-sm btn-success"
											...
											<i class="fa fa-plus-circle"></i> AGREGAR CÓMITE
										</button>
									</div>
								</div>
								<br><br>
								<table id="table_usuario"
									...
									<thead>
										<tr>
											<th class="text-center" style="width: 150px;  vertical-align: middle; background: #222D32;color: white;">Nombres</th>
											<th class="text-center" style="width: 150px;  vertical-align: middle; background: #222D32;color: white;">Cargo</th>
											<th class="text-center" style="width: 150px;  vertical-align: middle; background: #222D32;color: white;">Frima</th>
                                                                                        <th class="text-center" style="width: 150px;  vertical-align: middle; background: #222D32;color: white;">Estado</th>
											<th class="text-center" style="width: 150px;  vertical-align: middle; background: #222D32;color: white;">Acción</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
...
$(function () {
    ...
    table_usuario = $('#table_usuario').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('comite/lista_usuarios')?>",
            "type": "POST",
