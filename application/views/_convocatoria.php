								...
								<table id="table" class="table table-condensed table-hover responsive"
										...
										<thead style="background: #222D32;color: white;">
											<tr>
												...
												<th class="text-center" style="width: 10%" >Fecha de Publicación</th>
												<th style="width: 10%">Contratación Administrativa de Servicio - CAS</th>
												<th class="text-center" >Cantidad</th>
												<th class="text-center" style="width: 10%">Bases</th>
												<th class="text-center" style="width: 10%">Evaluación Hoja de vida</th>
												<th class="text-center" style="width: 10%">Exámen técnico</th>
         ...
         <div class="modal-body form">
            <form action="#" id="form_miembro" class="form-horizontal">
            	...
            	<div class="panel panel-success">
			      <div class="panel-heading"> Configuraciones Evaluación curricular </div>
		...
		function configurar_convocatoria(id){
				 $.ajax({
				        ...
				        success: function(data)
				        {
				        	...
				        	$('#modal-title-configurar').text('Formulario para la configuración de la convocatoria #'+ data.IDconvocatoria);
						},
				        error: function (jqXHR, textStatus, errorThrown)
				        {
				            alert('Error get data from ajax');
