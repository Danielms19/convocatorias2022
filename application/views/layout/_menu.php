    <header class="main-header">
        <nav class="navbar navbar-static-top">
          <div class="container">
            ...
            <li <?php   if($pag == 4){ echo 'class="active"'; } ?>><a href="<?php echo base_url(); ?>postulaciones"> Postulaciones</a></li>
             <li><a class="dropdown-toggle" data-toggle="dropdown" href="#"> Evaluaciones
                         <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li <?php   if($pag == 10){ echo 'class="active"'; } ?>><a href="<?php echo base_url(); ?>curricular"> Evaluación Curricular</a></li>
          <li <?php   if($pag == 13){ echo 'class="active"'; } ?>><a href="<?php echo base_url(); ?>tecnico"> Examen Técnico</a></li>
          <li <?php   if($pag == 11){ echo 'class="active"'; } ?>><a href="<?php echo base_url(); ?>entrevista"> Entrevista Personal</a></li>
        </ul>
             
             </li>
<!--            <li <?php   if($pag == 5){ echo 'class="active"'; } ?>><a href="<?php echo base_url(); ?>indicador"> Indicador</a></li>-->
